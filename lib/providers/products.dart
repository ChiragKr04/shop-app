...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    try {
      ...
      url =
          'https://animex-95911-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url =
        'https://animex-95911-default-rtdb.firebaseio.com/products.json?auth=$authToken';
    try {
